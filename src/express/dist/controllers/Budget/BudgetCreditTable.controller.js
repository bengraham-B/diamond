...
exports.getBudgetCreditTable = void 0;
const postgres_1 = __importDefault(require("../../Database/postgres"));
// Y This returns a table of debit budget for the year of each month
const getBudgetCreditTable = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if ((query.rowCount || 0) === 0)
            throw new Error("Could not get Credit Table Budget");
...
exports.getBudgetCreditTable = getBudgetCreditTable;
