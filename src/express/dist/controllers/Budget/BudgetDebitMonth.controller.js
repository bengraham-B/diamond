...
exports.getBudgetDebitMonth = void 0;
const postgres_1 = __importDefault(require("../../Database/postgres"));
// Y This returns a table of debit budget for the year of each month
const getBudgetDebitMonth = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res.status(200).json({ budgetDebitMonth: query.rows });
    }
    catch (error) {
        console.error(`${error}`);
...
exports.getBudgetDebitMonth = getBudgetDebitMonth;
