						...
						<tbody>
							...
							{creditBudgetTable && creditBudgetTable.map((cb) => (
                                <tr key={cb.id}>
                                    ...
                                    <td className='th-total'>R{(cb.diff_year_total || 0.00).toFixed(2)}</td>
                                </tr>
                            ))}
							...
							{debitBudgetTable && debitBudgetTable.map((cb) => (
                                <tr key={cb.id}>
                                    ...
                                    <td>R{(cb.may_diff || 0.00).toFixed(2)}</td>
